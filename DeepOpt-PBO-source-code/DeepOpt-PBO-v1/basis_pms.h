...
public:
	...
	int *best_soln_1800;
	double opt_time_300;
	double opt_time_1800;
	long long opt_unsat_weight_300;
	long long opt_unsat_weight_1800;
	long long obj_300;
	long long obj_1800;
	long long obj_3600;
	long long *opb;
	...
	int *clause_visied_times; // New Added
...
public:
	...
	void get_obj(string opb_file_name); // Used to deal with the objective function with negative coefficients
};
