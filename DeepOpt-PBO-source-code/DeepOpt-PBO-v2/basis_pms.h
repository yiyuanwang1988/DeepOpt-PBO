...
public:
	...
	/*hhscore*/
	long long *hhscore;
	int *clause_max_weight;
	long long *clause_total_sum;
	int *gap1;
	double ans;
	int *best_soln_300;
	int *best_soln_vo;
	double opt_time_300;
	double opt_time_vo;
	long long opt_unsat_weight_300;
	long long opt_unsat_weight_vo;
	long long obj_300;
	long long obj_3600;
	long long obj_vo;
	long long *opb;
	...
	/*fps*/
	long long *score_baocun;
	long long *sscore_baocun;
	long long *hhscore_baocun;
	long long *score2;
	long long *sscore2;
	long long *hhscore2;
	int *goodvar_stack2;
	...
	void init_vt(vector<int> &init_solution);
	void flip(int flipvar);
	void flip_fps(int flipvar);
	...
	void settings();
	void turb();
	int turb_pick_var(int last_flip_var);
	void init_turb();
...
public:
	...
	void local_search_vo(vector<int> &init_solution, char *inputfile);
	void local_search_vt(vector<int> &init_solution, char *inputfile);
	void simple_print();
	void print_best_solution(char *filename, char *seed);
	void free_memory();
	void check_new_score();
	void check_softunsat_weight();
	void get_obj(string opb_file_name);
};
